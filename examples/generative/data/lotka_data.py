...
if _in_ipython_session:
	...
	args = argparse.Namespace(split='train', savepath="./", seed=2026, verbose=1)
else:
...
if split == "train":
  n_traj_per_env = 1000*5     ## training
...
for j in range(n_traj_per_env):
    ...
    initial_state = np.random.uniform(size=(2,))*2. + 2.
...
#   prey_concentration, predator_concentration = solution.y.T
...
#   prey_concentration, predator_concentration = ys[...,0], ys[...,1]
  ...
  ani.save('./lotka_volterra.gif', fps=30)
# %%
