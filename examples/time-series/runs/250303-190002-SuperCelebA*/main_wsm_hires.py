...
grounding_length = 130          ## The length of the grounding pixel for the autoregressive digit generation
...
if not supervision_task=="classification":
    ...
    plt.draw();
    plt.savefig(run_folder+"reconstruction_hires.png", dpi=100, bbox_inches='tight')
